...
namespace Shale
{
    public class ShalePlugin : Slb.Ocean.Core.Plugin
    {
        ...
        {
            get { return "Vazgen and Vadim"; }
        }

        public override string Contact
        {
            get { return "brucelee73@mail.ru"; }
        }
        ...
        public override IEnumerable<ModuleReference> Modules
        {
            get 
            {
                ...
                yield return new ModuleReference(typeof(ShaleModule));
